						...
						<div class="col-md-12">
							<div class="panel panel-widget">
                                ...
                                <?php
                                    ...
                                    $id = $_GET['id'];
                                    $resultat =(mysqli_query($db, "SELECT * FROM client  where id=$id;"));
while ($ligne =  mysqli_fetch_array($resultat)) {
    ?>
									<form method="post" action="update_client_run.php?id=<?php echo $ligne['id'] ?>" class="valida" enctype="multipart/form-data" >
