...
<html>
<head>
<title>Baxster an Admin Panel Category Flat Bootstrap Responsive Website Template | Tables :: w3layouts</title>
		...
		<div class="sidebar" role="navigation">
            <div class="navbar-collapse">
				...
				<ul class="nav" id="side-menu">
							<li>
								<a href="home.html" class="active"><i class="fa fa-home nav_icon"></i>Acceuil</a>
							</li>
							<li>
								<a href="#"><i class="fa fa-cogs nav_icon"></i>Ajouter <span class="fa arrow"></span></a>
								<ul class="nav nav-second-level collapse">
									<li>
										<a href="add_question.php">Question</a>
									</li>
									<li>
										<a href="add_monitor.html">Monitor</a>
									</li>
									<li>
										<a href="add_level.html">Niveau</a>
									</li>
								</ul>
								<!-- /nav-second-level -->
							</li>
							...
							<li>
								<a href="question.php"><i class="fa fa-question"></i>&nbsp;&nbsp;&nbsp; Questions</a>
							</li>
							

							<li>
								<a href="reponse.php"><i class="fa fa-info"></i>&nbsp;&nbsp;&nbsp; Reponses</a>
							</li>

							<li>
								<a href="client.php"><i class="fa fa-user"></i>&nbsp;&nbsp;&nbsp; Clients</a>
							</li>

							<li>
								<a href="score.php"><i class="fa fa-list-ol"></i>&nbsp;&nbsp;&nbsp; Scores</a>
							</li>

							<li>
								<a href="monitor.php"><i class="fa fa-user"></i>&nbsp;&nbsp;&nbsp;  Monitors</a>
							</li>
...
<?php $resultat =(mysqli_query($db, "SELECT * FROM question;"));
...
?>
									...
									<tr>
									  ...
									  <td><?php echo $ligne['question'] ?></td>
									  <td><?php echo $ligne['level'] ?></td>
                                      <td><?php echo $ligne['choixun'] ?></td>
                                      <td><?php echo $ligne['choixdeux'] ?></td>
                                      <td><?php echo $ligne['choixtrois'] ?></td>
									  <td><?php echo $ligne['reponse'] ?></td>
									  <td>2<?php echo $ligne['img'] ?></td>


                                <td class="text-center">
                                <a class="text-primary" href="update_question.php?id=<?php echo $ligne['id'] ?>"><i class="fa fa-edit"></i></a>
                                &nbsp;&nbsp;
                                <a class="text-danger" href="delete_question.php?id=<?php echo $ligne['id'] ?>"><i class="fa fa-trash-o"></i></a>
                                </td>
