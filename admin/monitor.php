...
<?php $resultat =(mysqli_query($db, "SELECT * FROM monitor;"));
...
?>
									...
									<tr>
                                      ...
                                      <td><?php echo $ligne['datei'] ?></td>
									  <td>2<?php echo $ligne['img'] ?></td>


                                <td class="text-center">
                                <a class="text-primary" href="update_monitor.php?id=<?php echo $ligne['id'] ?>"><i class="fa fa-edit"></i></a>
                                &nbsp;&nbsp;
                                <a class="text-danger" href="delete_monitor.php?id=<?php echo $ligne['id'] ?>"><i class="fa fa-trash-o"></i></a>
                                </td>
