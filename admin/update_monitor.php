						...
						<div class="col-md-12">
							<div class="panel panel-widget">
                                ...
                                <?php
                                    ...
                                    $id = $_GET['id'];
                                    $resultat =(mysqli_query($db, "SELECT * FROM monitor  where id=$id;"));
while ($ligne =  mysqli_fetch_array($resultat)) {
    ?>
									<form method="post" action="update_monitor_run.php?id=<?php echo $ligne['id'] ?>" class="valida" enctype="multipart/form-data" >
										...
										<div class="form-group" >
											<input type="text" name="nom" id="field-1" required="true" class="form-control" value="<?php echo $ligne['nom'] ?>" />
										</div>

										<label for="field-2" >Prenom</label>
										<div class="form-group" >
											<input type="text" name="prenom" id="field-2" required="true" class="form-control" value="<?php echo $ligne['prenom'] ?>" />
										</div>

										<label for="field-3" >Cin</label>
										<div class="form-group" >
											<input type="text" name="cin" id="field-3"
												required="true"  class="form-control" value="<?php echo $ligne['cin'] ?>" />
										</div>


										<label for="field-4" >Email</label>
										<div class="form-group" >
											<input type="email" name="email" id="field-4"
												required="true"  class="form-control" value="<?php echo $ligne['email'] ?>" />
										</div>

                                        <label for="field-5" >Mot de passe</label>
										<div class="form-group" >
											<input type="password" name="password" id="field-5"
												required="true"  class="form-control" value="<?php echo $ligne['password'] ?>" />
										</div>
