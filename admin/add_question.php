					...
					<div class="forms-grids">
						<div class="col-md-12">
							<div class="panel panel-widget">
								<div class="my-div">
									<form method="post" action="add_question_run.php" class="valida" enctype="multipart/form-data" >
										...
										<div class="form-group" >
											<textarea name="cours" id="field-4" required="true" class="form-control" ></textarea>
										</div>
										
										<h4 >Question:</h4>

										<div class="form-group" >
											<textarea name="question" id="field-4" required="true" class="form-control" ></textarea>
										</div>
										...
										<div class="form-group" >
											<select name="level" id="field-2" required="true" class="form-control" >
												<option value=""></option>
												<?php
												require "connection_bd.php";
												$resultat =(mysqli_query($db, "SELECT * FROM levels;"));
...
?>
										...
										<label for="field-1" >Choix 1.1: (required)</label>
										<div class="form-group" >
											<input type="text" name="choix1" id="field-1" required="true" class="form-control" />
										</div>

										<label for="field-1-2" >Choix 1.2: </label>
										<div class="form-group" >
											<input type="text" name="choix2" id="field-1-2"  class="form-control"  />
										</div>

										<label for="field-1-3" >Choix 1.3: </label>
										<div class="form-group" >
											<input type="text" name="choix3" id="field-1-3"
												required="true"  class="form-control" />
										</div>

										<label for="field-7" >Photo</label>
										<div class="form-group" >
											<input type="file" name="img" id="field-7"
												required="true"  class="form-control" />
										</div>
