...
<html>
<head>
<title>Baxster an Admin Panel Category Flat Bootstrap Responsive Website Template | Validation :: w3layouts</title>
            ...
            <div class="navbar-collapse">
				<nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-right dev-page-sidebar mCustomScrollbar _mCS_1 mCS-autoHide mCS_no_scrollbar" id="cbp-spmenu-s1">
					<ul class="nav" id="side-menu">
						<li>
							<a href="index.html" class="active"><i class="fa fa-home nav_icon"></i>Acceuil</a>
						</li>
						<li>
							<a href="#"><i class="fa fa-cogs nav_icon"></i>Ajouter <span class="fa arrow"></span></a>
							<ul class="nav nav-second-level collapse">
								<li>
									<a href="add_question.html">Question</a>
								</li>
								<li>
									<a href="add_monitor.html">Monitor</a>
								</li>
								<li>
									<a href="grid.html">Niveau</a>
								</li>
							</ul>
							<!-- /nav-second-level -->
						</li>
						...
						<li>
							<a href="question.html"><i class="fa fa-question"></i>&nbsp;&nbsp;&nbsp; Questions</a>
						</li>
						

						<li>
							<a href="reponse.html"><i class="fa fa-info"></i>&nbsp;&nbsp;&nbsp; Reponses</a>
						</li>

						<li>
							<a href="client.html"><i class="fa fa-user"></i>&nbsp;&nbsp;&nbsp; Clients</a>
						</li>

						<li>
							<a href="score.html"><i class="fa fa-list-ol"></i>&nbsp;&nbsp;&nbsp; Scores</a>
						</li>

						<li>
							<a href="monitor.html"><i class="fa fa-user"></i>&nbsp;&nbsp;&nbsp;  Monitors</a>
						</li>

						<li>
							<a href="#"><i class="fa fa-envelope nav_icon"></i>Boite Email<span class="fa arrow"></span></a>
							<ul class="nav nav-second-level collapse">
								<li>
									<a href="inbox.html">Boite</a>
								</li>
								<li>
									<a href="compose.html">Nouveau email</a>
								</li>
							</ul>
							<!-- //nav-second-level -->
						</li>
						...
						<li>
							<a href="charts.html" class="chart-nav"><i class="fa fa-bar-chart nav_icon"></i>Statistique</a>
						</li>
						...
						<div class="col-md-12">
							<div class="panel panel-widget">
                                ...
                                <?php
                                    ...
                                    $id = $_GET['id'];
                                    $resultat =(mysqli_query($db, "SELECT * FROM question  where id=$id;"));
while ($ligne =  mysqli_fetch_array($resultat)) {
    ?>
									<form method="post" action="update_question_run.php?id=<?php echo $ligne['id'] ?>" class="valida" enctype="multipart/form-data" >
										...
										<label for="field-1" >Question</label>
										<div class="form-group" >
											<input type="text" name="question" id="field-1" required="true" class="form-control" value="<?php echo $ligne['question'] ?>" />
										</div>

										<label for="field-2" >Level</label>
										<div class="form-group" >
											<input type="text" name="level" id="field-2" required="true" class="form-control" value="<?php echo $ligne['level'] ?>" />
										</div>

										<label for="field-3" >Choix Un</label>
										<div class="form-group" >
											<input type="text" name="choix1" id="field-3"
												required="true"  class="form-control" value="<?php echo $ligne['choixun'] ?>" />
										</div>


										<label for="field-4" >Choix Deux</label>
										<div class="form-group" >
											<input type="email" name="choix2" id="field-4"
												required="true"  class="form-control" value="<?php echo $ligne['choixdeux'] ?>" />
										</div>

                                        <label for="field-5" >Choix Trois</label>
										<div class="form-group" >
											<input type="text" name="choix3" id="field-5"
												required="true"  class="form-control" value="<?php echo $ligne['choixtrois'] ?>" />
										</div>
                                    
										<h4 >Reponse Correcte:</h4>
									<div class="form-group" >
											<select name="reponse" id="field-2" required="true" class="form-control" >
												<option value="<?php echo $ligne['reponse'] ?>"><?php echo $ligne['reponse'] ?></option>
												<option value=""></option>
