...
<?php $resultat =(mysqli_query($db, "SELECT * FROM client;"));
...
?>
                                ...
                                <a class="text-primary" href="update_client.php?id=<?php echo $ligne['id'] ?>"><i class="fa fa-edit"></i></a>
                                &nbsp;&nbsp;
                                <a class="text-danger" href="delete_client.php?id=<?php echo $ligne['id'] ?>"><i class="fa fa-trash-o"></i></a>
                                </td>
