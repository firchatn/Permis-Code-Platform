...
<html lang="en">
<head>
<title>Driving School a Business Category Flat Bootstrap Responsive Website Template | Lessons :: w3layouts</title>
<!-- custom-theme -->
...
?>
				...
				<div class="col-md-4 agileits_services_grid">
					<div class="w3_agile_services_grid1">
						<img src="../admin/<?php echo $ligne['img'] ?>" alt=" " class="img-responsive" width= "300px" height="300px" />
						<div class="w3_blur"></div>
					</div>
					<h3><?php echo $ligne['nom'] ?></h3>
					<p>Niveau <?php echo $ligne['id'] ?>.</p>
					
					<div class="w3layouts_more">
						<a href="quiz1.php?id=<?php echo $ligne['id'] ?>" >Learn<i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
					</div>
				</div>
                <?php } ?>	
				<div class="clearfix"> </div>
