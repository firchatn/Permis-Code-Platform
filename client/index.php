...
<html lang="en">
<head>
<title>Driving School a Business Category Flat Bootstrap Responsive Website Template | Home :: w3layouts</title>
<!-- custom-theme -->
...
<!-- banner -->
	<div class="header">
        ...
        {
			?>
					<span  >  welcome  <i id="user" class="fa fa-user fa-2x" aria-hidden="true"></i> </span>
					<a href="logout.php" > <i id="user" class="fa fa-sign-out fa-2x" aria-hidden="true">  </i> </a>
					
		<?php } else { 
				
					?>
					<a href="login.html" ><i id="user" class="fa fa-user fa-2x" aria-hidden="true"></i> </a>
 <?php } ?>
				</div>
	...
	<div class="banner-bottom-icons">
		<div class="container">
			<div class="w3l-heading">
				<h2 class="w3ls_head">Notre Service </h2>
			</div>
...
<!-- about-us -->
	<div class="about">
		<div class="container">
			<div class="w3l-heading">
				<h3 class="w3ls_head">Qui Somme Nos </h3>
			</div>
